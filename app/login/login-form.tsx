...
function Form({ demoMode }: { demoMode: boolean }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm rounded-xl border border-zinc-800 bg-zinc-900 p-8 shadow-xl">
        ...
        {/*
          Without this, a visitor who lands on /login from a stale link in demo
          mode has no way back to the thing they were sent to look at, and the
          password box reads as "you are not welcome here".
        */}
        {demoMode && (
          <Link
            href="/"
            className="mt-6 flex items-center justify-center gap-1.5 text-xs text-zinc-500 transition hover:text-zinc-300"
          >
